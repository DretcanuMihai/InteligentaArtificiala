...
class GeneticAlgorithm:
    ...
    def __jump_one_generation_normal(self):
        """
    ...
    def __set_jump(self):
        ...
        if mode == 'elitism':
            ...
            self.__jump_function = self.__jump_one_generation_normal
    ...
    def jump_one_generation(self):
        """
        jumps one generation
        :return: None
        """
